...
version: 1.0.0
description: |
  Self-improvement system enabling Claude Code to detect code quality violations, retrieve past fix patterns from memory, and orchestrate automated improvement cycles. Uses Connascence Analyzer for 7+ v
category: quality
tags:
- quality
- testing
...
A comprehensive 3-phase self-improvement system that enables Claude Code to automatically im
