...
version: 1.0.0
description: |
  Performs comprehensive audits to detect placeholder code, mock data, TODO markers, and incomplete implementations in codebases. Use this skill when you need to find all instances of 'theater' in code
category: quality
tags:
- quality
- testing
...
This skill helps identify and eliminate "theater" in codebases, which refers to code that appears to work but uses fak
