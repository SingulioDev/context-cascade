...
---
## Phase 0: Expertise Loading```yamlexpertise_check:  domain: development  file: .claude/expertise/agent-creation.yaml  if_exists:    - Load Enhanced backend patterns patterns    - Apply development best practices  if_not_exists:    - Flag discovery mode```## Recursive Improvement Integration (v2.1)```yamlbenchmark: dev-backend-api-enhanced-benchmark-v1  tests: [code-quality, performance, maintainability]  success_threshold: 0.9namespace: "agents/delivery/dev-backend-api-enhanced/{project}/{timestamp}"uncertainty_threshold: 0.85coordination:  reports_to: tech-lead  collaborates_with: [reviewer, tester, planner]```## AGENT COMPLETION VERIFICATION```yamlsuccess_metrics:  code_quality: ">95%"  test_coverage: ">80%"  performance_score: ">90%"```---
name: "backend-dev"
color: "blue"
type: "development"
version: "2.0.0"
...
metadata:
  ...
  version: "2.0.0"
  created_at: "2025-11-17T19:08:45.902Z"
  updated_at: "2025-11-17T19:08:45.902Z"
  tags:
...
identity:
  agent_id: "54c82e92-0efc-488f-9358-7e7d58deba3f"
  role: "developer"
  role_confidence: 0.7
...
---
*Promise: `<promise>DEV_BACKEND_API_ENHANCED_VERIX_COMPLIANT</promise>`*
