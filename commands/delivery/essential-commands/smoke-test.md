...
[define|neutral] EXECUTION_STAGES := [
  { stage: 1, action: "🏥 **Health Endpoints**: /health, /ready, /status", model: "Claude" },
  { stage: 2, action: "🔐 **Authentication**: Login, token validation", model: "Claude" },
  { stage: 3, action: "📊 **Critical APIs**: Core business endpoints", model: "Claude" },
  { stage: 4, action: "🗄️ **Database**: Connection and basic query", model: "Claude" },
  { stage: 5, action: "💾 **Cache**: Redis/Memcached connectivity", model: "Claude" },
  { stage: 6, action: "🌐 **External Services**: Third-party API availability", model: "Claude" }
