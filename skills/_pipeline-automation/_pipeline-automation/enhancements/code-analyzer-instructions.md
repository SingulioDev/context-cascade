...
# Enhancement Instructions for code-analyzer
...
**Location**: `code-analyzer/README.md`
...
**Location**: `code-analyzer/examples/`
...
**Location**: `code-analyzer/references/`
...
**Location**: `code-analyzer/graphviz/`
...
**Location**: `code-analyzer/resources/`
...
**BEFORE starting**:
```bash
npx claude-flow@alpha hooks pre-task --description "Enhance code-analyzer to Gold tier"
```

**DURING work**:
```bash
npx claude-flow@alpha hooks post-edit --file "{file}" --memory-key "skill-enhancement-pipeline/code-analyzer/{component}"
```

**AFTER completion**:
```bash
npx claude-flow@alpha hooks post-task --task-id "enhance-code-analyzer"
npx claude-flow@alpha memory store --key "skill-enhancement-pipeline/code-analyzer/status" --value "enhanced-to-Gold"
```
