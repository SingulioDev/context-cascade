...
# Enhancement Instructions for cicd-engineer
...
**Location**: `cicd-engineer/README.md`
...
**Location**: `cicd-engineer/examples/`
...
**Location**: `cicd-engineer/references/`
...
**Location**: `cicd-engineer/graphviz/`
...
**Location**: `cicd-engineer/resources/`
...
**BEFORE starting**:
```bash
npx claude-flow@alpha hooks pre-task --description "Enhance cicd-engineer to Gold tier"
```

**DURING work**:
```bash
npx claude-flow@alpha hooks post-edit --file "{file}" --memory-key "skill-enhancement-pipeline/cicd-engineer/{component}"
```

**AFTER completion**:
```bash
npx claude-flow@alpha hooks post-task --task-id "enhance-cicd-engineer"
npx claude-flow@alpha memory store --key "skill-enhancement-pipeline/cicd-engineer/status" --value "enhanced-to-Gold"
```
