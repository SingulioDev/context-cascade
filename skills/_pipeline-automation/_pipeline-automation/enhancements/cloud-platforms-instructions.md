...
# Enhancement Instructions for cloud-platforms
...
## Skill Purpose
--- name: cloud-platforms description: Multi-cloud deployment and infrastructure management across AWS, GCP, and Azure. Use when deploying applications to cloud platforms, implementing serverless arch...
...
**Location**: `cloud-platforms/README.md`
...
**Location**: `cloud-platforms/examples/`
...
**Location**: `cloud-platforms/references/`
...
**Location**: `cloud-platforms/graphviz/`
...
**BEFORE starting**:
```bash
npx claude-flow@alpha hooks pre-task --description "Enhance cloud-platforms to Silver tier"
```

**DURING work**:
```bash
npx claude-flow@alpha hooks post-edit --file "{file}" --memory-key "skill-enhancement-pipeline/cloud-platforms/{component}"
```

**AFTER completion**:
```bash
npx claude-flow@alpha hooks post-task --task-id "enhance-cloud-platforms"
npx claude-flow@alpha memory store --key "skill-enhancement-pipeline/cloud-platforms/status" --value "enhanced-to-Silver"
```
