# Skill Forge SOP - Quick Reference (v2.0)

## 8-Phase Overview

| Phase | Agent | Duration | Key Output |
|-------|-------|----------|------------|
| 0. Expertise Loading [NEW] | - | 5-10 min | Expertise context or discovery flag |
...
```
coordination/skill-forge/phase0/expertise-loading
...
**Purpose:** Load domain expertise before beginning skill creation

**Key Tasks:**
- Detect domain from skill request
- Check for expertise file in .claude/expertise/
- Load and validate expertise if available
- Flag discovery mode if expertise missing

**Deliverable:** Expertise context or discovery flag

**Success Criteria:**
- Domain identified
- Expertise loaded (if available)
- Context applied to subsequent phases
