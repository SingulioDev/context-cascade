# Skill Forge Enhanced - Agent-Orchestrated SOP (v2.0)
...
**v2.0 Update**: Now includes Phase 0 (Expertise Loading) for 8-phase total methodology.

## Documentation Structure

| File | Purpose | Audience |
|------|---------|----------|
| **SKILL-ENHANCED.md** | Complete 8-phase SOP with agent invocations | Skill creators (primary document) |
...
| **SKILL.md** | Main skill-forge (v2.0 with recursive improvement) | Primary reference |
...
- All 8 phases with detailed instructions (Phase 0-7)
...
## The 8-Phase Process (v2.0)

### Phase 0: Expertise Loading [NEW]
...
**Total Time:** 105-170 minutes (1.75-2.75 hours)
...
### Process Diagrams
**Locations:**
- `skill-forge-sop-process.dot` - Complete 8-phase flow (v2.0)
- `skill-forge-process.dot` - Main diagram with Phase 0 (v2.0)
...
1. Follow all 8 phases (0-7) in **SKILL-ENHANCED.md**
