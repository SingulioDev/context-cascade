...
description: Advanced skill creation system with explicit agent orchestration for Claude Flow. Uses systematic SOP methodology coordinating researcher, analyst, architect, coder, tester, and reviewer agents to transform intent into production-quality skills. Applies evidence-based prompting, program-of-thought decomposition, and self-consistency validation throughout the 8-phase workflow (v2.0 adds Phase 0 expertise loading).
version: 2.1.0
---
